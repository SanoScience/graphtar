...
python3 experiments/deepmirtar/sd_autoencoder.py data_modules/configs/deepmirtar_config.json 1234 0.001 $SLURM_JOBID 1000 experiments/deepmirtar/models
