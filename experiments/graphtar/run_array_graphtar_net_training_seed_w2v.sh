...
python3 experiments/graphtar/gnn_w2v.py data_modules/configs/graphtar_config_deepmirtar.json GCN MAX 64 2 64 2 0.4 $SLURM_ARRAY_TASK_ID 0.001 128 1000 experiments/graph/models